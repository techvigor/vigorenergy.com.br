...
const faqs = [
    ...
    },
    {
        ...
        answer:
            'Nossos clientes economizam até 28% na conta de luz, dependendo do seu consumo e região. Após você realizar a simulação de economia, nós calculamos sua média de consumo à partir da sua conta de luz e informamos exatamente quanto você pode economizar.',
    },
    {
